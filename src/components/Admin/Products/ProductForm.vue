<template>
  <form @submit.prevent="submit">
    ...
    <div class="form-footer">
      <ve-button class="action" :disabled="loading" :loading="loading" type="submit" color="success">Submit</ve-button>
...
export default {
  ...
  methods: {
    ...
    imageInputChangeHandler(e) {
      // console.log(e.target.files); https://www.javascripture.com/FileReader
      this.imageFile = e.target.files[0];
      this.reader.readAsDataURL(this.imageFile);
    },
    editProduct() {
      return this.$store.dispatch("AdminStore/ProductsModule/submitEditProductForm", {
        product: this.form,
    ...
    addProduct() {
      return this.$store.dispatch("AdminStore/ProductsModule/submitProductForm", {
        product: this.form,
        imageFile: this.imageFile,
      });
    },
